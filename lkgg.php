    ...
    <div style="margin-top: 40px; margin-left: 45px;">
        <table>
            <tbody>
                ...
                <tr style="height: 60px;">
                    <td> Tên độc giả: </td>
                    <td> <input type="text" name="tendg" value="<?php echo isset($_POST['tendg']) ? $_POST['tendg'] : $row['tendg'];?>" style="width: 400px; padding-left: 10px;"> </td>
                </tr>
                ...
                <tr style="height: 60px;">
                    <td> Giới tính: </td>
                    <td> <input type="text" name="gioitinh" value="<?php echo isset($_POST['gioitinh']) ? $_POST['gioitinh'] : $row['gioitinh'];?>" style="width: 400px; padding-left: 10px;"> </td>
                </tr>
                ...
                <tr style="height: 150px;">
                    <td colspan="3">
                        ...
                        if ($row['img']!='') {
                            $img = $row['img'];
                            echo "<img src='img/$img' style='width: 120px; height:120px; border: 1px solid blue; margin-top:20px; background-color: white;' onclick='triggerClick()' id='display_img' name='name'>";
            ...
            <tbody>
                ...
                <tr style="height: 50px;">
                    ...
                    <td>
                        ...
                        $google_login_btn = '<a href="'.$google_client->createAuthUrl().'" style="text-decoration: none;color: blue; ">Liên kết</a>';
                        echo '<div align="center" style="background-color: white;color: blue; border-radius: 5px; border: 1px solid blue; margin-left: 100px;">'.$google_login_btn . '</div>';
                        ?>
                    </td>
                </tr>
            </tbody>
